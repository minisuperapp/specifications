...
api_requester.send = async (request, customer_session_token, deliverer_session_token) => {
  ...
  try {
    ...
    const customerSessionToken = getSessionTokenCookie(res, 'customer_session_token')
    const delivererSessionToken = getSessionTokenCookie(res, 'deliverer_session_token')
