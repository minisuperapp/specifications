Feature: Get Offers For All Products As Customer
  ...
  Scenario: Get Only Offers Within Deliverer's Radius For One Product
    Given Deliverer 'D1' publishes a new offer for product 'CORN_TORTILLA' with price '20.00' with location '28.1867348', '-105.4608849' and delivery radius of 100 M
    And Deliverer 'D2' publishes a new offer for product 'CORN_TORTILLA' with price '19.99' with location '29.1867348', '-106.4708849' and delivery radius of 50 M
